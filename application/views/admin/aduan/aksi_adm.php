...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            ?>
            <form role="form" method="post" action="<?= base_url('admin/aduan/aksi_adm') ?>" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <?php
                        echo anchor('admin/aduan/aduan_admin', 'Kembali', array('class' => 'btn btn-primary'));
                        ?>
                    </div><br/>
            </form>
        </div>
